...
export const metadata: Metadata = {
  title: "Our Projects — 50+ Fire Safety Projects Across Egypt",
  description:
    "View Xenon's portfolio of 50+ completed fire safety and security projects across Egypt. Banking, healthcare, industrial, sports, education, and commercial sectors including National Bank of Egypt, Wadi Degla Clubs, and major factories.",
  keywords: [
  ...
  openGraph: {
    title: "50+ Fire Safety & Security Projects | Xenon Trade & Contracting",
  ...
  twitter: {
    ...
    title: "50+ Fire Safety Projects Across Egypt | Xenon",
